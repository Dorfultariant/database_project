...
insert into Member (member_id, first_name, last_name, address, phone_number, email) values (1002,'Mair', 'Wolfarth'     , '460 Johnson Park'    , '597-488-0051'        , 'mwolfarth2@network.org'   );
...
insert into Member (member_id, first_name, last_name, address, phone_number, email) values (1017,'Gardiner', 'Welband'  , '492 Eagle Crest Way', '464-855-7728'         , 'gw@networksolutions.com');
...
insert into Publisher (publisher_id, publisher_name, address, email) values (5004, 'Mynte', '68538 Garrison Circle'     , 'sewence4@rambler.su');
insert into Publisher (publisher_id, publisher_name, address, email) values (5005, 'Testi', '68538 Garrison Circle'     , 'sewence2@rambler.su');
